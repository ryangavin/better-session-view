// Ableton Live's built-in clip color table, in `color_index` order.
//
// Live 12.4.3 reports 70 colors arranged row-major in the 14 × 5 picker. This
// table is product data, not user state: the runtime uses it directly and never
// mutates a Live Set to rediscover it. The developer-only palette sweep in
// bridge/src/lom.ts is the tool for checking this constant after a Live update.
