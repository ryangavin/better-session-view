...
- `npm test -- --project=mix --project=widgets`: 88 files, 843 tests passed.
...
All 21 checks passed in the Codex in-app browser. Representative measured results:
...
| Synced pause captured RMS | 9.18e-7 |
...
- Waveform tools and deck/master controls were visually inspected in the scrolling layout.
