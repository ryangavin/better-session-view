...
| audio interface, sample rate, latency or restarting the audio graphs | [`docs/audio-settings.md`](docs/audio-settings.md) — `src/audioSettings.ts`, `src/components/AudioSettingsModal.tsx` |
