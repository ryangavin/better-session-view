...
| stem separation, or demucs | [`mix/README.md`](mix/README.md) — 2 topic docs. `@openflow/mix`: **mix[flow]**. The window is built; what is in it is a mockup, and nothing separates yet. Talks to no bridge and no server |
