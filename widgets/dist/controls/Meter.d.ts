...
export declare function Meter({ value, peak, orientation, name, label, layout, display, showValue, width, length, className, title, }: MeterProps): import("react").JSX.Element;
