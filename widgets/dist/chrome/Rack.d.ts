...
import { type DeviceProps } from './Device.tsx';
import './chrome.css';
/**
...
export declare function Rack({ macros, chains, chainAt, onChain, children, className, ...device }: RackProps): import("react").JSX.Element;
