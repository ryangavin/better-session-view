...
export declare function Device({ name, on, onToggle, folded, onFold, selected, onSelect, onHotSwap, headerStart, headerAfterName, headerEnd, inlets, outlets, screen, chooser, portRows, children, vars, className, title, }: DeviceProps): import("react").JSX.Element;
...
export declare function DevicePortRow({ inlet, outlet, children, className }: DevicePortRowProps): import("react").JSX.Element;
