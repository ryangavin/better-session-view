...
/**
 * The eighteen shapes the `form` node marches, and the order is the argument.
 *
 ...
 * corolla of rounded and circular loops, a coaxial open-arc spindle, then a
 * corridor the eye is inside.
