...
/**
 * The twenty-one shapes the `form` node marches, and the order is the argument.
 *
 ...
 * forming a vault and central arcade, a prolate meridian graticule enclosing
 * an inset equatorial hoop barrel, then a corridor the eye is inside.
